...
params = {"reflevel":1700,"upperbound":1100,"lowerbound":3500,"mixs":{"kvo":True,"kvb":True,"kh":True},"3point":False,"edgeguard":False}
...
graph.graphVectorField(inv,"uabs","vabs","pv",\
        metadata=out["metadata"],region="nepb",\
        savepath="refpics/vectorfields/allmixpyneutralsearch8splinexy/pv/",show=False,transform=True)
