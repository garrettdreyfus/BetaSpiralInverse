...
Zenk 1993 Blend: 2.516e-04      2.653e-04       3.240e-04
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Sensitivity Study_files/Sensitivity Study_4_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
from the western part at this depth.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Sensitivity Study_files/Sensitivity Study_6_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Zenk 1993 Blend: 2.297e-04      2.510e-04       3.090e-04
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Sensitivity Study_files/Sensitivity Study_8_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Zenk 1993 Blend: 2.447e-04      2.608e-04       3.193e-04
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Sensitivity Study_files/Sensitivity Study_10_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Zenk 1993 Blend: 2.415e-04      2.587e-04       3.171e-04
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Sensitivity Study_files/Sensitivity Study_13_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Zenk 1993 Blend: 2.387e-04      2.568e-04       3.152e-04
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Sensitivity Study_files/Sensitivity Study_15_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
(post-interpolation)}\label{difference-along-surfaces-between-surfaces-with-noise-added-and-those-without-post-interpolation}}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Sensitivity Study_files/Sensitivity Study_17_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
scale}\label{sensitivity-to-bottom-roughness-decay-scale}}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Sensitivity Study_files/Sensitivity Study_19_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Zenk 1993 Blend: 2.403e-04      2.579e-04       3.163e-04
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Sensitivity Study_files/Sensitivity Study_21_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Zenk 1993 Blend: 2.457e-04      2.615e-04       3.200e-04
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Sensitivity Study_files/Sensitivity Study_23_1.png}
    \end{center}
    { \hspace*{\fill} \\}
