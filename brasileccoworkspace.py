...
#profilechoice = nstools.profileInBox(profiles,-40,-37,-31,-29,4000)
...
###graph.graphSurfaces(brasil,surfaces,"gamma")
...
surfaces = eccotools.addModelEccoMix(surfaces,"BRASILEAST")
graph.graphSurfaces(brasil,surfaces,"kapredi")
...
#graph.graphVectorField(brasil,inv,"uabs","vabs","pres",show=False, \
        #savepath="refpics/vectorfields/eccobrasil/spread/nomix/",scale=0.5,transform=False)
