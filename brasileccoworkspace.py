...
#graph.graphSurfaces(brasil,preinterpsurfaces,"pres",select=[1100])
...
##params = {"reflevel":1700,"upperbound":1000,"lowerbound":4000,\
        ...
        ##"3point":False,"edgeguard":True,"modelmixing":True,\
...
#graph.graphVectorField(brasil,inv,"uabs","vabs","pres",show=False, \
        #savepath="refpics/vectorfields/eccomixbrasilgamma/inverse4/",scale=0.1,transform=False)
