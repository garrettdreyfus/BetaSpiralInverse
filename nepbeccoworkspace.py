...
#profilechoice = nstools.profileInBox(profiles,-159,-157,53,55,4000)
...
##graph.graphSurfaces(nepb,surfaces,"pres",select=[1100])
...
graph.graphVectorField(nepb,inv,"uabs","vabs","z",\
        metadata=out["metadata"],refarrow=0.003,\
        transform=False,show=False,scale=0.05,\
        savepath="refpics/vectorfields/nepbecco/inversemodelmixsmart/")
