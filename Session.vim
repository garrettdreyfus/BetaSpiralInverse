...
exe 'vert 2resize ' . ((&columns * 122 + 86) / 173)
exe '3resize ' . ((&lines * 16 + 21) / 43)
exe 'vert 3resize ' . ((&columns * 122 + 86) / 173)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let s:l = 104 - ((19 * winheight(0) + 20) / 40)
...
wincmd w
argglobal
if bufexists("nstools.py") | buffer nstools.py | else | edit nstools.py | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 370 - ((21 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
370
...
wincmd w
argglobal
terminal ++curwin ++cols=122 ++rows=16 
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 2536 - ((10 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2536
